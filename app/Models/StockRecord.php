...
class StockRecord extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            $financial_period = Utils::getActiveFinancialPeriod($stock_item->pharmacy_id);
            ...
            $model->pharmacy_id = $stock_item->pharmacy_id;
        ...
        static::created(function ($model) {
            ...
            // $pharmacy = Pharmacy::find($model->pharmacy_id);
            // if ($pharmacy == null) {
            ...
            //         Pharmacy::prepare_account_categories($pharmacy->id);
            //         $financial_category = FinancialCategory::where([
            //             ['pharmacy_id', '=', $pharmacy->id],
            //             ['name', '=', 'Sales']
            //         ])->first();
            ...
            //     $fin_rec->pharmacy_id = $pharmacy->id;
    ...
    /*
    pharmacy_id, stock_item_id, stock_category_id, stock_sub_category_id, created_by_id, sku, name, measurement_unit, description, type, quantity, selling_price, total_sales
    */
}
